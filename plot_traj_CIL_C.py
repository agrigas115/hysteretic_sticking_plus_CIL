...
file = 'traj_data/traj_0_p'+p+'_v0_'+v0+'_phi'+target_phi+'_T_'+target_temp+'_gamma_'+gamma+'_seq_'+seq+'.txt'
...
frame = 0
bonded_list_list = []
file = 'bonded_data/bonded_0_p'+p+'_v0_'+v0+'_phi'+target_phi+'_T_'+target_temp+'_gamma_'+gamma+'_seq_'+seq+'.txt'
sourcelines = []
...
# 
# arrows = ax.quiver(x[:num_atoms],y[:num_atoms],arrow_list_plot[0][:,0],arrow_list_plot[0][:,1],color='r',zorder=300,scale=1.0,scale_units='xy')
# 
# 
...
# ani.save('CIL_p'+p+'_v0_'+v0+'_phi'+target_phi+'_T_'+target_temp+'_gamma_'+gamma+'.mp4', writer=writer, dpi=300)
# 
# plt.close(fig)
# 
# 
